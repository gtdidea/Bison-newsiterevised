...
For a comprehensive analysis, contact us at info@thebisongroup.io
  ...
  const generatePersonalizedInsights = (data: SurveyData) => {
    ...
    if (data.industryChallenge.includes('digital')) {
      insights += "🔍 DIGITAL TRANSFORMATION PRIORITY:\n";
    ...
    if (data.industryChallenge.includes('competition')) {
      insights += "⚡ COMPETITIVE ADVANTAGE OPPORTUNITY:\n";
    ...
    if (data.teamSize === 'startup') {
      insights += "🚀 STARTUP GROWTH STRATEGY:\n";
      ...
      insights += "🏢 ENTERPRISE OPTIMIZATION:\n";
      insights += "Large organizations benefit from our Triplicity™ Solutions for coordinated strategic execution across departments.\n\n";
    }
              ...
              <CardContent className="space-y-4">
                ...
                <div className="bg-blue-50 p-4 rounded-lg">
                  ...
                  <ul className="text-sm space-y-1">
                    <li>• Personalized strategic assessment report</li>
                    <li>• Industry-specific recommendations</li>
                    <li>• Implementation roadmap suggestions</li>
                    <li>• Complimentary consultation opportunity</li>
                  </ul>
                </div>
              </CardContent>
            </Card>
